...
| [Official `greedbest/docs` customization page](https://github.com/greedbest/docs/blob/60cf7138d45a74bf0cf3fc749c1dc6c43b00df43/customization.mdx) | `customize name/avatar/banner/bio/reset`; image URL/attachment input; older 200-character bio wording. | Command names are corroborated by the pinned registry. The 200-character limit loses to the current premium page and pinned `bio` response, both of which say 190. |
