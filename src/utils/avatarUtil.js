...
/**
 * Build an avatar embed for a user
 * @param {User} user - Discord user object
 * @param {GuildMember|null} member - Guild member object (null if in DMs)
 * @returns {EmbedBuilder} Avatar embed
 */
function buildAvatarEmbed(user, member) {
    // Get avatar URLs
