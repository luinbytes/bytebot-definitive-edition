...
CREATE TABLE `__new_moderation_logs` (
	...
	`reason` text,
	`timestamp` integer DEFAULT '"2025-12-26T22:23:30.494Z"'
);
...
CREATE TABLE `__new_bytepods` (
	...
	`created_at` integer DEFAULT '"2025-12-26T22:23:30.495Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_bookmarks` (
	...
	`saved_at` integer DEFAULT '"2025-12-26T22:23:30.495Z"',
...
CREATE TABLE `__new_media_gallery_config` (
	...
	`created_at` integer DEFAULT '"2025-12-26T22:23:30.495Z"',
	`updated_at` integer DEFAULT '"2025-12-26T22:23:30.495Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_activity_streaks` (
	...
	`created_at` integer DEFAULT '"2025-12-26T22:23:30.496Z"',
	`updated_at` integer DEFAULT '"2025-12-26T22:23:30.496Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_activity_achievements` (
	...
	`earned_at` integer DEFAULT '"2025-12-26T22:23:30.496Z"'
);
--> statement-breakpoint
...
ALTER TABLE `guilds` ADD `media_archive_channel_id` text;