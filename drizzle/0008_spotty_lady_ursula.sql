CREATE TABLE `achievement_definitions` (
	...
	`seasonal_event` text,
	`created_at` integer DEFAULT '"2025-12-28T01:25:06.619Z"'
);
...
CREATE TABLE `achievement_role_config` (
	...
	`created_at` integer DEFAULT '"2025-12-28T01:25:06.619Z"',
	`updated_at` integer DEFAULT '"2025-12-28T01:25:06.619Z"'
);
--> statement-breakpoint
CREATE TABLE `achievement_roles` (
	...
	`created_at` integer DEFAULT '"2025-12-28T01:25:06.620Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_moderation_logs` (
	...
	`reason` text,
	`timestamp` integer DEFAULT '"2025-12-28T01:25:06.618Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_bookmarks` (
	...
	`saved_at` integer DEFAULT '"2025-12-28T01:25:06.619Z"',
...
CREATE TABLE `__new_activity_achievements` (
	...
	`points` integer DEFAULT 0 NOT NULL,
	`earned_at` integer DEFAULT '"2025-12-28T01:25:06.619Z"'
);
--> statement-breakpoint
INSERT INTO `__new_activity_achievements`("id", "user_id", "guild_id", "achievement_id", "notified", "points", "earned_at") SELECT "id", "user_id", "guild_id", "achievement_id", "notified", "points", "earned_at" FROM `activity_achievements`;--> statement-breakpoint
