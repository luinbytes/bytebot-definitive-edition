...
CREATE TABLE `__new_moderation_logs` (
	...
	`reason` text,
	`timestamp` integer DEFAULT '"2025-12-26T21:14:16.517Z"'
);
...
CREATE TABLE `__new_bytepods` (
	...
	`created_at` integer DEFAULT '"2025-12-26T21:14:16.517Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_bookmarks` (
	...
	`saved_at` integer DEFAULT '"2025-12-26T21:14:16.517Z"',
...
CREATE TABLE `__new_media_gallery_config` (
	...
	`created_at` integer DEFAULT '"2025-12-26T21:14:16.517Z"',
	`updated_at` integer DEFAULT '"2025-12-26T21:14:16.517Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_suggestions` (
	...
	`reviewed_at` integer,
	`review_reason` text,
	`created_at` integer DEFAULT '"2025-12-26T21:14:16.518Z"',
...
CREATE TABLE `__new_activity_streaks` (
	...
	`created_at` integer DEFAULT '"2025-12-26T21:14:16.518Z"',
	`updated_at` integer DEFAULT '"2025-12-26T21:14:16.518Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_activity_achievements` (
	...
	`earned_at` integer DEFAULT '"2025-12-26T21:14:16.518Z"'
);
--> statement-breakpoint
