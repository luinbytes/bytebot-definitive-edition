...
INSERT INTO `__new_bytepod_user_settings`("user_id", "guild_id", "auto_lock") SELECT "user_id", "guild_id", "auto_lock" FROM `bytepod_user_settings`;--> statement-breakpoint
...
CREATE TABLE `__new_moderation_logs` (
	...
	`reason` text,
	`timestamp` integer DEFAULT '"2025-12-31T17:10:03.219Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_bytepods` (
	...
	`created_at` integer DEFAULT '"2025-12-31T17:10:03.219Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_bookmarks` (
	...
	`saved_at` integer DEFAULT '"2025-12-31T17:10:03.219Z"',
...
CREATE TABLE `__new_media_gallery_config` (
	...
	`created_at` integer DEFAULT '"2025-12-31T17:10:03.219Z"',
	`updated_at` integer DEFAULT '"2025-12-31T17:10:03.219Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_media_items` (
	...
	`saved_at` integer DEFAULT '"2025-12-31T17:10:03.220Z"',
	`message_deleted` integer DEFAULT false NOT NULL,
...
CREATE TABLE `__new_media_tags` (
	...
	`created_at` integer DEFAULT '"2025-12-31T17:10:03.220Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_activity_streaks` (
	...
	`created_at` integer DEFAULT '"2025-12-31T17:10:03.220Z"',
	`updated_at` integer DEFAULT '"2025-12-31T17:10:03.220Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_activity_achievements` (
	...
	`awarded_by` text,
	`earned_at` integer DEFAULT '"2025-12-31T17:10:03.220Z"'
);
--> statement-breakpoint
