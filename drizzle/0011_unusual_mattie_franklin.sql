...
CREATE TABLE `__new_moderation_logs` (
	...
	`reason` text,
	`timestamp` integer DEFAULT '"2026-01-02T22:29:33.683Z"'
);
...
CREATE TABLE `__new_bytepods` (
	...
	`created_at` integer DEFAULT '"2026-01-02T22:29:33.683Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_bookmarks` (
	...
	`saved_at` integer DEFAULT '"2026-01-02T22:29:33.683Z"',
...
CREATE TABLE `__new_media_gallery_config` (
	...
	`created_at` integer DEFAULT '"2026-01-02T22:29:33.683Z"',
	`updated_at` integer DEFAULT '"2026-01-02T22:29:33.683Z"'
);
--> statement-breakpoint
...
CREATE INDEX `media_file_hash_guild_idx` ON `media_items` (`file_hash`,`guild_id`);--> statement-breakpoint
CREATE TABLE `__new_media_tags` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`media_id` integer NOT NULL,
	`tag` text NOT NULL,
	`auto_generated` integer DEFAULT false NOT NULL,
	`created_at` integer DEFAULT '"2026-01-02T22:29:33.684Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_activity_streaks` (
	...
	`created_at` integer DEFAULT '"2026-01-02T22:29:33.684Z"',
	`updated_at` integer DEFAULT '"2026-01-02T22:29:33.684Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_activity_achievements` (
	...
	`awarded_by` text,
	`earned_at` integer DEFAULT '"2026-01-02T22:29:33.684Z"'
);
--> statement-breakpoint
...
CREATE UNIQUE INDEX `custom_achievements_guild_id_achievement_id_unique` ON `custom_achievements` (`guild_id`,`achievement_id`);