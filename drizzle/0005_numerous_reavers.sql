...
CREATE TABLE `__new_moderation_logs` (
	...
	`reason` text,
	`timestamp` integer DEFAULT '"2025-12-26T21:15:21.603Z"'
);
...
CREATE TABLE `__new_bytepods` (
	...
	`created_at` integer DEFAULT '"2025-12-26T21:15:21.603Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_bookmarks` (
	...
	`saved_at` integer DEFAULT '"2025-12-26T21:15:21.603Z"',
...
CREATE TABLE `__new_media_gallery_config` (
	...
	`created_at` integer DEFAULT '"2025-12-26T21:15:21.603Z"',
	`updated_at` integer DEFAULT '"2025-12-26T21:15:21.603Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_media_items` (
	...
	`saved_at` integer DEFAULT '"2025-12-26T21:15:21.604Z"',
	`message_deleted` integer DEFAULT false NOT NULL,
...
CREATE TABLE `__new_media_tags` (
	...
	`created_at` integer DEFAULT '"2025-12-26T21:15:21.604Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_activity_streaks` (
	...
	`created_at` integer DEFAULT '"2025-12-26T21:15:21.604Z"',
	`updated_at` integer DEFAULT '"2025-12-26T21:15:21.604Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_activity_achievements` (
	...
	`earned_at` integer DEFAULT '"2025-12-26T21:15:21.604Z"'
);
--> statement-breakpoint
